...
function film_type()
{
    ...
    $labels = array(
        'name' => _x($plural, 'Post Type General Name', 'twentytwenty'),
        'singular_name' => _x($singular, 'Post Type Singular Name', 'twentytwenty'),
        'menu_name' => __($plural, 'twentytwenty'),
        'parent_item_colon' => __('Parent ' . $singular, 'twentytwenty'),
        'all_items' => __('All ' . $plural, 'twentytwenty'),
        'view_item' => __('View ' . $singular, 'twentytwenty'),
        'add_new_item' => __('Add New ' . $singular, 'twentytwenty'),
        'add_new' => __('Add New', 'twentytwenty'),
        'edit_item' => __('Edit ' . $singular, 'twentytwenty'),
        'update_item' => __('Update ' . $singular, 'twentytwenty'),
        'search_items' => __('Search ' . $plural, 'twentytwenty'),
        'not_found' => __('Not Found', 'twentytwenty'),
        'not_found_in_trash' => __('Not found in Trash', 'twentytwenty'),
    );

    $args = array(
        'label' => __($plural, 'twentytwenty'),
        'labels' => $labels,
...
function taxonomies()
{
    ...
    foreach ($taxonomies as $taxonomy) {
        ...
        $labels = array(
            'name' => _x($plural, 'taxonomy generate name'),
        ...
        register_taxonomy(strtolower($singular), 'film', $args);
    }
...
function comma_separated_taxonomy_callback($taxonomy)
{
...
add_action('comma_separated_taxonomy', 'comma_separated_taxonomy_callback');

function film_fields_callback()
{
    echo "Country: ";
    do_action('comma_separated_taxonomy','country');

    echo "<br>";

    echo "Genre: ";
    do_action('comma_separated_taxonomy','genre');
    echo "<br>";
...
add_action('film_fields', 'film_fields_callback')
